    ...
    <div className='min-h-screen flex flex-col justify-center items-center'>
        ...
        <div className='m-5 py-20 rounded-3xl max-w-7xl bg-gray-300 bg-opacity-50 backdrop-blur-md transition-all duration-500 flex flex-col justify-center items-center'>
            ...
            <div className='p-10 md:p-20 text-justify max-w-6xl xl:text-2xl'>
                <p>Soon after the Jalpaiguri Government Engineering College came into existence, the then students felt the need to create a society that could have represented the latent creativity among students. Thus in the year 1969 Magazine Club was constituted.</p>
                <br />
                <p>Since it got established, The Magazine Club of JGEC has been striding steadily in the realm of Literature and Arts. Since 1969, the Magazine Club has always put its nose on the grindstone and reflected upon the essence of the college through its various editions. With an impeccable record of 50+ glorious years, The Magazine Club has become synonymous with pride and prestige for any member, who has been a part of this great institution.</p>
            </div>
