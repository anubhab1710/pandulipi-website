  ...
  return (
    <div className="min-h-screen gap-x-60 bg-[#252B42] flex flex-col justify-center items-center xl:flex-row">
      <img
        ...
        src="https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fd28hgpri8am2if.cloudfront.net%2Fbook_images%2Fonix%2Fcvr9781421539669%2Fdeath-note-black-edition-vol-3-9781421539669_hr.jpg&f=1&nofb=1&ipt=a5a617b12c7a14d830d31db465e3888a092f636b8a2f7b650dde2fd8a7cb8a6e&ipo=images"
        alt=""
      />
