    ...
    <>
      <div className="bg-[#EEEEEE]  w-full">
        ...
        <div className="flex flex-col justify-center pb-10 items-center xl:flex-row-reverse">
          <img
            src="https://3.bp.blogspot.com/-1IG_dpBvLqQ/Ta_sTsPwFgI/AAAAAAAAACk/ga8pkFXy2WU/s1600/free+business+powerpoint+templates.jpg"
            alt=""
            className="m-10 p-10 h-[400px]"
          />
          <div className="text-xl max-w-4xl text-center m-10 xl:text-right">
            <p>
              ...
              suscipit voluptates deleniti provident, dicta facilis.Lorem ipsum
              dolor sit, amet consectetur adipisicing elit. Ad recusandae
              adipisci mollitia, deserunt quaerat repellat expedita nemo
              consectetur pariatur nulla odit minima sint asperiores suscipit
              voluptates deleniti provident, dicta facilis.Lorem ipsum dolor
              sit, amet consectetur adipisicing elit. Ad recusandae adipisci
              mollitia, deserunt quaerat repellat expedita nemo consectetur
              pariatur nulla odit minima sint asperiores suscipit voluptates
              deleniti provident, dicta facilis Lorem ipsum dolor sit, amet
              consectetur adipisicing elit. Ad recusandae adipisci mollitia,
              deserunt quaerat repellat expedita nemo consectetur pariatur nulla
              odit minima sint asperiores suscipit voluptates deleniti
              provident, dicta facilisLorem ipsum dolor sit, amet consectetur
              adipisicing elit. Ad recusandae adipisci mollitia, deserunt
              quaerat repellat expedita nemo consectetur pariatur nulla odit
              minima sint asperiores suscipit voluptates deleniti provident,
              dicta facilis
            </p>
            <br />
            <p>
              ...
              adipisci mollitia, deserunt quaerat repellat expedita nemo
              consectetur pariatur nulla odit minima sint asperiores suscipit
              voluptates deleniti provident, dicta facilis
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col items-center">
          <div className="flex flex-col justify-center items-center xl:flex-row-reverse">
            <img
              ...
              className="visible xl:visible lg:h-[310px] m-10"
            />
            <div className="max-w-4xl text-xl text-center m-10 xl:text-right">
              <p>
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ad
                recusandae adipisci mollitia, deserunt quaerat repellat expedita
                nemo consectetur pariatur nulla odit minima sint asperiores
