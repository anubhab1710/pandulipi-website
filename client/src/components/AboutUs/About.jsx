      ...
      <div className="bg-[#EEEEEE]  w-full">
        ...
        <div className="flex flex-col justify-center pb-10 items-center xl:flex-row-reverse">
          <div className="text-xl max-w-4xl text-center m-10 xl:text-left">
            <p>
            The word ‘Pandulipi’ has a very special place in the Bengali Language. It means ‘Manuscripts’. JGEC’s very first ‘Pandulipi’ was printed in 1961, when it was named Ekkani. A group of like-minded poets, artists and dialectics came out of the shell of engineering to weave magic, through the love of language and literature. Pandulipi is a pillar of cultural exuberance. At our college’s beloved Magazine Club, we invite all budding poets, artists, painters, musicians, and aesthetes to join hands and celebrate the joy of everyday life. From Tagore to Ray, from Gulzar to Dylan, from Van Gogh to Jamini Roy, the Magazine Club celebrates art and culture through several events, programmes and festivals throughout the year. If you are a music-maker yourself, join us at the Writer’s Block, our community of budding poets. Given Jolu’s mystical surroundings and the warm embrace of the foothills of the Himalayas, you might get lost too in these manuscripts of old, and find yourself gaining a fresh perspective on life, philosophy and yourself!
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col items-center">
          <div className="flex flex-col justify-center items-center xl:flex-row">
            ...
            <div className="max-w-4xl text-xl text-center m-10 xl:text-left">
              <p>
              It gives me immense pleasure to inform that since past few years, our college magazine, "PANDULIPI," has been
              covering all of JGEC's activities. I'm quite delighted to show the comprehensive records of our magazine club's college
              activities and performances. It has taken many steps in order to develop the students' abilities. "PANDULIPI" is the
              stage on which our students' profound knowledge and skills are displayed. Our students are developing their talents
              through writing, interactions, presentations, and personality development, in addition to mastering hard skills. 'They
              are ready to realise their full potential and put their thoughts and experiences to good use for the greater good.
              Through reading, group discussions, writing competitions, research-oriented courses, and other activities, we instil in
              our students a culture of original thinking, as well as nurturing and growing physical and mental strength to resist any
              scenario.
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center">
          <div className="flex flex-col justify-center items-center xl:flex-row-reverse">
            <img
              ...
              className="visible xl:visible lg:h-[310px] m-10"
            />
            <div className="max-w-4xl text-lg text-center m-10 xl:text-right">
              <p>
