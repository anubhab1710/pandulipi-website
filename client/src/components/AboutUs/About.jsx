      ...
      <div className="bg-[#EEEEEE]">
        ...
        <div className="flex flex-col items-center">
          <div className="flex flex-col justify-center items-center xl:flex-row">
            <img src={President} alt="" className="lg:h-72 h-56 rounded-md" />
            <div className="max-w-4xl xl:max-w-2xl text-xl text-justify m-10 xl:text-left">
              <p>
          ...
          <div className="p-10">
            <p className="lg:text-left text-xl text-justify max-w-4xl xl:max-w-6xl">
        ...
        <div className="flex flex-col items-center">
          <div className="flex flex-col justify-center items-center xl:flex-row-reverse">
            ...
            <div className="max-w-4xl text-lg text-justify m-10 xl:text-right">
              <p>
                লেখার জন্য কি প্রয়োজন? কাগজ আর কলম? আর কিছু নয়? অনুভূতি
                লাগেনা? অনুভব করার ক্ষমতা? আর সেই অনুভব করবার শক্তি থাকলে কি
                পারিপার্শ্বিকতা বাদ পড়ে? একজন লেখকের পারিপার্শ্বিকতা কতদূর
                পর্যন্ত বিস্তৃত? তার জেলা, রাজ্য, দেশ? নাকি সারা পৃথিবী জুড়ে
                তার বিস্তার? লেখকের অনুভূতির গণ্ডি তার বাইরেও ছড়িয়ে। অনুভব
                শক্তির বলে লেখকই কি যথার্থ বিশ্বনাগরিক নয়? এবং এর জন্যই কি সব
                সমস্যায় লেখকই সবার আগে আক্রান্ত হয়? সকল সামাজিক সমস্যার
                সমাধানে লেখকই সবার আগে এগিয়ে যায়। লেখক তার অনুভূতি দিয়ে,
                ভাবনা দিয়ে, কল্পনা দিয়ে যে সমাধান ভাবে, বিজ্ঞান ও প্রযুক্তি কি
                সেটাই বাস্তবায়িত করে না? করোনার আবির্ভাবে মানব সভ্যতা আজ যেভাবে
                ধ্বংসের মুখে এসে দাঁড়িয়েছে সাহিত্যকেও আজ এগিয়ে আসতে হবে।
                সাহিত্য তার স্বভাবসিদ্ধ পথে এগিয়ে এসে আজও সমাধানের পথ দেখাক,
                সাহস জুগাক, আমাদের মানসিকভাবে প্রস্তুত করুক। সাহিত্যের কাছে,
