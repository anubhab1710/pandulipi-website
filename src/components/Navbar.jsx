            ...
            <div className="container flex flex-wrap items-center justify-between mx-auto">
                ...
                <div className="hidden w-full lg:block lg:w-auto" id="navbar-default">
                    <ul className="flex flex-col md:items-center p-4 mt-4 border rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:text-lg md:font-medium md:border-0  bg-gray-800 md:bg-gray-900 border-gray-700">
                        ...
                        <li>
                            <NavLink to="/team" className="block hover:bg-opacity-20 py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent" style={({ isActive }) => isActive ? { color: '#00B8FF ', fontWeight: 'bold' } : { color: 'white', fontWeight: 'normal' }}>Team</NavLink>
                        </li>
