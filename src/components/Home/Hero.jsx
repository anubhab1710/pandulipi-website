...
function Hero() {
  return (
    <div className='min-h-screen flex flex-col justify-center items-center'>
        ...
        <div className='m-5 py-20 rounded-3xl max-w-7xl bg-gray-300 bg-opacity-50 backdrop-blur-3xl hover:backdrop-blur-sm transition-all duration-500 flex flex-col justify-center items-center'>
